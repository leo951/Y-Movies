...
public class AdapterMovie extends ArrayAdapter<Results> {

    private int resId;

    public AdapterMovie(@NonNull Context context, int resource, @NonNull List<Results> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        myViewHolder.nameMovie.setText(item.getTitle());
        Picasso.get()
                .load(url)
